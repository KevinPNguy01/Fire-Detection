...
static esp_err_t post_status_handler(httpd_req_t *req) {
  char buf[100];
...
void startCameraServer() {
  ...
  httpd_uri_t post_status_uri = {
    .uri = "/status",
    .method = HTTP_POST,
    .handler = post_status_handler,
    .user_ctx = NULL
  };
  ...
  if (httpd_start(&camera_httpd, &config) == ESP_OK) {
    ...
    httpd_register_uri_handler(camera_httpd, &post_status_uri);
  }
